...
Autocomplete.prototype = {
  ...
  initialize: function(){
    ...
    $('autocomplete_container').appendChild(div);
  ...
  onValueChange: function(){
    ...
    (this.options.onValueChange || Prototype.emptyFunction)(this.currentValue);
  },
  ...
  suggest: function(){
    ...
    var content = [];
    var re = new RegExp('^' + this.currentValue.match(/[[A-Za-zА-Яа-я0-9_]+/g).join('|\\b'), 'gi');
